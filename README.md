# hinotori ロールインシミュレーター
**Hinotori Surgical Robot Roll-in Simulator**

[![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)

🔗 **公開URL**: https://kawashimakatsuki.github.io/hinotori-Roll-in-Simulator.App/
...
1. ブラウザで以下のURLを開く（またはQRコードからアクセス）  
   👉 https://kawashimakatsuki.github.io/hinotori-Roll-in-Simulator.App/
